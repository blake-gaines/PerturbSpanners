...
def get_graph(graphName, weights="Equal", seedPlus=1, nTrials=1, inputDir=None):
    # process inputs
    ...
    if inputDir: filename = inputDir+'/'+graphName+'_'+weights+'Weights_part_'+str(seedPlus)+'_'+str(nTrials)+'trials.pkl'
